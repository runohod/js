...
// Способ как ловить подобнве ошибки это обернуть код внутри колбэка
// setTimeout(() => {
//   try {
...
///////////////////////////////////////////////////////////////// Задание 9:///////////////////////////////////////////////////////////////
//Предсказать порядок вывода в консоль, без подсмотра в консоль. И объяснить результат:
// console.log(1);
...
// 1 потому что вывод сразу, 2 setTimeout отправляется в очередь, 3 хоть и асинхронный, но отправляется в очередь микрозадач, 4 сразу выполняется
// и того имеем сразу 1 4 потом разгребаем микрозадачи (3) и уже в оставтке 2 переходит в микрозадачи и выполняем


///////////////////////////////////////////////////////////////// Задание 10:///////////////////////////////////////////////////////////////
// Напиши функцию, которая принимает СИНХРОННУЮ операцию, но выполняет ее всегда асинхронно. 
// То есть:
...
// потому что все таймеры в макро пулл сукинули, и тут же выводим 4, далее выводим 1 т.к. у него не указано сколько времени === 0, следом 3 т.к. 0 < 10 секунд
// явно таймер вышел по времени и готов к исполнению и в остатке (2)
